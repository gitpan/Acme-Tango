...
print qq!<html><head><title>Acme::Tango Example</title></head><body><table bgcolor = '#000000'><tr>!;

for my $flavour (qw(orange lemon apple)) {

	print "<td><h1><font color = '#ffffff'>$flavour</font></h1><table>\n";
	...
	for my $color (@colors) {
		...
		# Tango it
		my $hex_orange = Acme::Tango::drink($color, $flavour);
